...
function usage() {
	...
	echo " L     install <feature schema> [--depforce] [--depignore] [--export=<path>] [--portable=<path>] : install a feature. [--depforce] will force to reinstall all dependencies.[--depignore] will ignore dependencies. schema = feature_name[#version][@arch][:binary|source][/os_restriction][\os_exclusion]"
