...
feature_radare2() {
	FEAT_NAME=radare2
	FEAT_LIST_SCHEMA="1_2_1:source SNAPSHOT:source"
	FEAT_DEFAULT_VERSION=1_2_1
	FEAT_DEFAULT_ARCH=
...
feature_radare2_SNAPSHOT() {
	...
	FEAT_SOURCE_URL=https://github.com/dmlc/radare2
...
feature_radare2_install_source() {
	...
	__get_resource "$FEAT_NAME" "$FEAT_SOURCE_URL" "$FEAT_SOURCE_URL_PROTOCOL" "$SRC_DIR" "STRIP VERSION $FEAT_GIT_TAG"
