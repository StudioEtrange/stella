...
feature_miniconda2_4_5_12() {
	FEAT_VERSION=4_5_12

	if [ "$STELLA_CURRENT_PLATFORM" = "darwin" ]; then
		FEAT_BINARY_URL_x64=https://repo.continuum.io/miniconda/Miniconda2-4.5.12-MacOSX-x86_64.sh
		FEAT_BINARY_URL_FILENAME_x64=Miniconda2-4.5.12-MacOSX-x86_64.sh
		FEAT_BINARY_URL_PROTOCOL_x64=HTTP
	fi

	if [ "$STELLA_CURRENT_PLATFORM" = "linux" ]; then
		FEAT_BINARY_URL_x86=https://repo.continuum.io/miniconda/Miniconda2-4.5.12-Linux-x86.sh
		FEAT_BINARY_URL_FILENAME_x86=Miniconda2-4.5.12-Linux-x86.sh
		FEAT_BINARY_URL_PROTOCOL_x86=HTTP

		FEAT_BINARY_URL_x64=https://repo.continuum.io/miniconda/Miniconda2-4.5.12-Linux-x86_64.sh
		FEAT_BINARY_URL_FILENAME_x64=Miniconda2-4.5.12-Linux-x86_64.sh
		FEAT_BINARY_URL_PROTOCOL_x64=HTTP
	fi
