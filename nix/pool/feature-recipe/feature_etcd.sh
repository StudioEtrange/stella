...
feature_etcd_2_3_7() {
	...
	if [ "$STELLA_CURRENT_PLATFORM" == "linux" ]; then
		...
		FEAT_BINARY_URL_x64=https://github.com/coreos/etcd/releases/download/v2.3.7/etcd-v2.3.7-linux-amd64.tar.gz
	...
	if [ "$STELLA_CURRENT_PLATFORM" == "darwin" ]; then
		...
		FEAT_BINARY_URL_FILENAME_x86=
		FEAT_BINARY_URL_PROTOCOL_x86=
		FEAT_BINARY_URL_x64=https://github.com/coreos/etcd/releases/download/v2.3.7/etcd-v2.3.7-darwin-amd64.zip
