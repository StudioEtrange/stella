...
feature_reg() {
	FEAT_NAME=reg
	FEAT_LIST_SCHEMA="0_13_0@x64:binary 0_13_0@x86:binary 0_9_0@x64:binary 0_9_0@x86:binary"
...
feature_reg_0_13_0() {
	...
	if [ "$STELLA_CURRENT_PLATFORM" = "darwin" ]; then
		FEAT_BINARY_URL_x86="https://github.com/jessfraz/reg/releases/download/v0.13.0/reg-darwin-386"
		FEAT_BINARY_URL_FILENAME_x86="reg-darwin-386-$FEAT_VERSION"
		FEAT_BINARY_URL_PROTOCOL_x86="HTTP"
		FEAT_BINARY_URL_x64="https://github.com/jessfraz/reg/releases/download/v0.13.0/reg-darwin-amd64"
		FEAT_BINARY_URL_FILENAME_x64="reg-darwin-amd64-$FEAT_VERSION"
		FEAT_BINARY_URL_PROTOCOL_x64="HTTP"
	fi
	if [ "$STELLA_CURRENT_PLATFORM" = "linux" ]; then
		FEAT_BINARY_URL_x86="https://github.com/jessfraz/reg/releases/download/v0.13.0/reg-linux-386"
		FEAT_BINARY_URL_FILENAME_x86="reg-linux-386-$FEAT_VERSION"
		FEAT_BINARY_URL_PROTOCOL_x86="HTTP"
		FEAT_BINARY_URL_x64="https://github.com/jessfraz/reg/releases/download/v0.13.0/reg-linux-amd64"
