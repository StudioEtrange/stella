...
feature_docker-machine() {
	...
	FEAT_LIST_SCHEMA="0_14_0@x64:binary 0_13_0@x64:binary 0_10_0@x64:binary 0_8_2@x64:binary 0_2_0@x64:binary 0_2_0@x86:binary 0_4_0@x86:binary 0_4_0@x64:binary 0_5_6@x64:binary 0_6_0@x64:binary 0_7_0@x64:binary"
...
feature_docker-machine_0_14_0() {
	...
	if [ "$STELLA_CURRENT_PLATFORM" = "darwin" ]; then
		...
		FEAT_BINARY_URL_FILENAME_x64=docker-machine-Darwin-x86_64-0_14_0
	...
	if [ "$STELLA_CURRENT_PLATFORM" = "linux" ]; then
		...
		FEAT_BINARY_URL_FILENAME_x64=docker-machine-Linux-x86_64-0_14_0
		FEAT_BINARY_URL_PROTOCOL_x64=HTTP
	fi
...
feature_docker-machine_0_13_0() {
	...
	if [ "$STELLA_CURRENT_PLATFORM" = "darwin" ]; then
		...
		FEAT_BINARY_URL_FILENAME_x64=docker-machine-Darwin-x86_64-0_13_0
		FEAT_BINARY_URL_PROTOCOL_x64=HTTP
	fi
	...
	if [ "$STELLA_CURRENT_PLATFORM" = "linux" ]; then
		...
		FEAT_BINARY_URL_FILENAME_x64=docker-machine-Linux-x86_64-0_13_0
		FEAT_BINARY_URL_PROTOCOL_x64=HTTP
	fi
...
feature_docker-machine_0_10_0() {
	...
	if [ "$STELLA_CURRENT_PLATFORM" = "darwin" ]; then
		...
		FEAT_BINARY_URL_FILENAME_x64=docker-machine-Darwin-x86_64-0_10_0
		FEAT_BINARY_URL_PROTOCOL_x64=HTTP
	fi
	...
	if [ "$STELLA_CURRENT_PLATFORM" = "linux" ]; then
		...
		FEAT_BINARY_URL_FILENAME_x64=docker-machine-Linux-x86_64-0_10_0
		FEAT_BINARY_URL_PROTOCOL_x64=HTTP
	fi
