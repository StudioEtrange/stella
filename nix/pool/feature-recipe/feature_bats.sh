...
feature_bats_1() {
	...
	FEAT_BUNDLE_ITEM="bats-core#1_7_0 bats-assert#2_0_0 bats-support#0_3_0"
...
feature_bats_setenv() {
	...
	echo "-- When using bats instruction 'load bats-assert', it will search bats-assert folder inside those folders list"
