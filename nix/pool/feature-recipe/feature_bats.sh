...
function feature_bats() {
	FEAT_NAME=bats
	FEAT_LIST_SCHEMA="SNAPSHOT:source harschware_SNAPSHOT:source julthomas_SNAPSHOT:source"
...
function feature_bats_julthomas_SNAPSHOT() {
	FEAT_VERSION=julthomas_SNAPSHOT
	
	FEAT_SOURCE_DEPENDENCIES=
	FEAT_BINARY_DEPENDENCIES=

	FEAT_SOURCE_URL=https://github.com/julthomas/bats
	...
	FEAT_GIT_BRANCH="dev/jth/ready-for-pull"
	SOURCE_OPTION="VERSION $FEAT_GIT_BRANCH"
	
}


function feature_bats_harschware_SNAPSHOT() {
	FEAT_VERSION=harschware_SNAPSHOT
	
	FEAT_SOURCE_DEPENDENCIES=
	FEAT_BINARY_DEPENDENCIES=

	FEAT_SOURCE_URL=https://github.com/harschware/bats
	FEAT_SOURCE_URL_FILENAME=
	FEAT_SOURCE_URL_PROTOCOL=GIT
