...
feature_terraform() {
	...
	FEAT_NAME=terraform
	[ "$STELLA_CURRENT_PLATFORM" = "darwin" ] && FEAT_LIST_SCHEMA="0_11_5@x64:binary 0_9_6@x64:binary 0_9_4@x64:binary"
	[ "$STELLA_CURRENT_PLATFORM" = "linux" ] && FEAT_LIST_SCHEMA="0_11_5@x64:binary 0_11_5@x86:binary 0_9_6@x64:binary 0_9_6@x86:binary 0_9_4@x64:binary 0_9_4@x86:binary"
	FEAT_DEFAULT_ARCH=x64
	FEAT_DEFAULT_FLAVOUR="binary"
}

feature_terraform_0_11_5() {
	FEAT_VERSION=0_11_5
	...
	if [ "$STELLA_CURRENT_PLATFORM" = "darwin" ]; then
		FEAT_BINARY_URL_x64=https://releases.hashicorp.com/terraform/0.11.5/terraform_0.11.5_darwin_amd64.zip
		FEAT_BINARY_URL_FILENAME_x64=terraform_0.11.5_darwin_amd64.zip
		FEAT_BINARY_URL_PROTOCOL_x64=HTTP_ZIP
	fi
	if [ "$STELLA_CURRENT_PLATFORM" = "linux" ]; then
		FEAT_BINARY_URL_x64=https://releases.hashicorp.com/terraform/0.11.5/terraform_0.11.5_linux_amd64.zip
		FEAT_BINARY_URL_FILENAME_x64=terraform_0.11.5_linux_amd64.zip
		FEAT_BINARY_URL_PROTOCOL_x64=HTTP_ZIP
		FEAT_BINARY_URL_x86=https://releases.hashicorp.com/terraform/0.11.5/terraform_0.11.5_linux_386.zip
		FEAT_BINARY_URL_FILENAME_x86=terraform_0.11.5_linux_386.zip
