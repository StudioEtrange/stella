...
function __install_kibana_4_0_0_b3() {
	URL=https://download.elasticsearch.org/kibana/kibana/kibana-4.0.0-beta3.tar.gz
	VER=4_0_0_b3
	FILE_NAME=kibana-4.0.0-beta3.tar.gz
	__install_kibana_internal

	# NEED Elasticsearch
}

function __feature_kibana_4_0_0_b3() {
	FEATURE_TEST="$STELLA_APP_FEATURE_ROOT/kibana/4_0_0_b3/bin/kibana"
	FEATURE_RESULT_ROOT="$STELLA_APP_FEATURE_ROOT/kibana/4_0_0_b3"
