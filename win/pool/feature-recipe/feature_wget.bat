...
:install_wget_1_11_4
	...
	if "!TEST_FEATURE!"=="0" (	
		call %STELLA_COMMON%\common.bat :uncompress "%STELLA_POOL%\feature\wget-1.11.4-1-bin.zip" "%INSTALL_DIR%"
		call %STELLA_COMMON%\common.bat :uncompress "%STELLA_POOL%\feature\wget-1.11.4-1-dep.zip" "%INSTALL_DIR%"
