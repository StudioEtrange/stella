...
:feature_cmake_3_1_2
	...
	set FEATURE_PATH=
	set FEATURE_VER=
	if exist "%STELLA_APP_FEATURE_ROOT%\cmake\3_1_2-win32-x86\bin\cmake.exe" (
		set "TEST_FEATURE=1"
		set "FEATURE_ROOT=%STELLA_APP_FEATURE_ROOT%\cmake\3_1_2-win32-x86"
		set "FEATURE_PATH=!FEATURE_ROOT!\bin"
		set FEATURE_VER=3_1_2
		if %VERBOSE_MODE% GTR 0 (
			echo ** EXTRA FEATURE Detected : cmake in !FEATURE_ROOT!
		)
	)
