...
:feature_cmake
	set "FEAT_NAME=cmake"
	set "FEAT_LIST_SCHEMA=3_3_2@x86:binary 3_1_2@x86:binary 2_8_12@x86:binary"
	set "FEAT_DEFAULT_VERSION=3_3_2"
...
:feature_cmake_3_3_2
	...
	set "FEAT_BINARY_URL_x86=https://cmake.org/files/v3.3/cmake-3.3.2-win32-x86.zip"
