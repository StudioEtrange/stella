...
:feature_nodejs
	...
	set "FEAT_LIST_SCHEMA=22_17_0@x64:binary 22_17_0@x86:binary 6_10_2@x64:binary 6_10_2@x86:binary"
	set "FEAT_DEFAULT_VERSION=22_17_0"
...
:feature_nodejs_22_17_0
	...
	set "FEAT_BINARY_URL_x64=https://nodejs.org/dist/v22.17.0/node-v22.17.0-win-x64.zip"
	set "FEAT_BINARY_URL_FILENAME_x64=node-v22.17.0-win-x64.zip"
	set "FEAT_BINARY_URL_PROTOCOL_x64=HTTP_ZIP"
	set "FEAT_BINARY_URL_x86=https://nodejs.org/dist/v22.17.0/node-v22.17.0-win-x86.zip"
	set "FEAT_BINARY_URL_FILENAME_x86=node-v22.17.0-win-x86.zip"
