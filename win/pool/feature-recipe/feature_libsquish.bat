...
:feature_libsquish_1_13
	...
	set "FEAT_INSTALL_TEST=!FEAT_INSTALL_ROOT!\bin\libsquish16.dll"
...
:feature_libsquish_install_source
	...
	set "AUTO_INSTALL_CONF_FLAG_POSTFIX=-DBUILD_SQUISH_WITH_SSE2=ON -DBUILD_SQUISH_WITH_ALTIVEC=OFF -DBUILD_SHARED_LIBS=ON -DBUILD_SQUISH_EXTRA=OFF"
