...
:feature_docker
	...
	set "FEAT_LIST_SCHEMA=20_10_17@x64:binary 17_09_0_CE@x64:binary 17_06_2_CE@x64:binary 1_12_3@x64:binary 1_12_3@x86:binary 1_6_0@x64:binary 1_6_0@x86:binary"
	set "FEAT_DEFAULT_VERSION=20_10_17"
	set "FEAT_DEFAULT_ARCH=x64"
	set "FEAT_DEFAULT_FLAVOUR=binary"
goto :eof


:feature_docker_20_10_17
	set "FEAT_VERSION=20_10_17"
	...
	set "FEAT_BINARY_URL_x64=https://download.docker.com/win/static/stable/x86_64/docker-20.10.17.zip"
	set "FEAT_BINARY_URL_FILENAME_x64=docker-win-x86_64-20.10.17.zip"
