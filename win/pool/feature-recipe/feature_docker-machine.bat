...
:feature_docker-machine
	...
	set "FEAT_LIST_SCHEMA=0_13_0@x64:binary 0_13_0@x86:binary 0_8_2@x64:binary 0_8_2@x86:binary 0_2_0@x64:binary 0_2_0@x86:binary 0_4_0@x86:binary 0_4_0@x64:binary"
...
:feature_docker-machine_0_13_0
	...
	set "FEAT_BINARY_URL_x64=https://github.com/docker/machine/releases/download/v0.13.0/docker-machine-Windows-x86_64.exe"
	set "FEAT_BINARY_URL_FILENAME_x64=docker-machine-Windows-x86_64-0_13_0.exe"
	set FEAT_BINARY_URL_PROTOCOL_x64=HTTP
	set "FEAT_BINARY_URL_x86=https://github.com/docker/machine/releases/download/v0.13.0/docker-machine-Windows-i386.exe"
	set "FEAT_BINARY_URL_FILENAME_x86=docker-machine-Windows-i386-0_13_0.exe"
