...
:init_proxy
	...
	if not "!STELLA_PROXY_ACTIVE!"=="" (
		...
		if "!STELLA_PROXY_USER!"=="" (
			...
			set "STELLA_HTTPS_PROXY=https://!STELLA_PROXY_HOST!:!STELLA_PROXY_PORT!"
		) else (
			...
			set "STELLA_HTTPS_PROXY=https://!STELLA_PROXY_USER!:!STELLA_PROXY_PASS!@!STELLA_PROXY_HOST!:!STELLA_PROXY_PORT!"
		)
