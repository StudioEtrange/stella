...
:api_list
	set "%~1=[ COMMON-API : %STELLA_API_COMMON_PUBLIC% ] [ FEATURE-API : %STELLA_API_FEATURE_PUBLIC% ] 	[ APP-API : %STELLA_API_APP_PUBLIC% ] [ PLATFORM-API : %STELLA_API_PLATFORM_PUBLIC% ] [ BUILD-API : %STELLA_API_BUILD_PUBLIC% ] [ API : %STELLA_API_API_PUBLIC%]"
goto :eof
