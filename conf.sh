...
__STELLA_FEATURE_LIST="gnu-netcat maven spark sbt scala docker-machine jq wget ninja cmake packer autotools perl gettext getopt ucl upx elasticsearch kibana nginx ngrok go pcre libtool m4 automake autoconf"
