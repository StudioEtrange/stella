...
STELLA_API_APP_PUBLIC="link_current_app get_data get_assets get_all_data get_all_assets update_data update_assets revert_data revert_assets get_env_properties setup_env get_features"
