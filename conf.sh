...
STELLA_API_NETWORK_PUBLIC="find_free_port get_ip_external find_free_tcp_port check_tcp_port_open ssh_execute get_ip_from_hostname get_ip_from_interface proxy_tunnel enable_proxy disable_proxy no_proxy_for register_proxy register_no_proxy"
...
# NOTE : to test a function that return an exit code :
