...
make_sevenzip_sfx_bin make_targz_sfx_shell compress"
...
STELLA_API_RETURN_FUNCTION="is_abs mercurial_project_version git_project_version get_stella_version list_active_features get_filename_from_string get_key"
