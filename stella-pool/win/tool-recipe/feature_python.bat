...
:install_python
	...
	if not exist %STELLA_TOOL_ROOT%\python mkdir %STELLA_TOOL_ROOT%\python
	if "%_VER%"=="" (
...
:install_python_2_7_6
	...
	set VERSION=2_7_6
	set "INSTALL_DIR=%STELLA_TOOL_ROOT%\python\%VERSION%"
...
:feature_python_2_7_6
	...
	set FEATURE_PATH=
	set FEATURE_VER=
	if exist "%STELLA_TOOL_ROOT%\python\2_7_6\python.exe" (
		set "TEST_FEATURE=%STELLA_TOOL_ROOT%\python\2_7_6"
	)
	if not "!TEST_FEATURE!"=="0" (
