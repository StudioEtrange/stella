...
echo herreeee
	if not exist %STELLA_TOOL_ROOT%\jom mkdir %STELLA_TOOL_ROOT%\jom
	if "%_VER%"=="" (
...
:install_jom_1_0_13
	...
	set "INSTALL_DIR=%STELLA_TOOL_ROOT%\jom\1_0_13"
...
:feature_jom_1_0_13
	...
	set FEATURE_PATH=
	set FEATURE_VER=
	if exist "%STELLA_TOOL_ROOT%\jom\1_0_13\jom.exe" (
		set "TEST_FEATURE=%STELLA_TOOL_ROOT%\jom\1_0_13"
	)
