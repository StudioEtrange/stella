...
echo herreeee
	if not exist %TOOL_ROOT%\jom mkdir %TOOL_ROOT%\jom
	if "%_VER%"=="" (
...
:install_jom_1_0_13
	...
	set "INSTALL_DIR=%TOOL_ROOT%\jom\1_0_13"
...
:feature_jom_1_0_13
	...
	set FEATURE_PATH=
	set FEATURE_VER=
	if exist "%TOOL_ROOT%\jom\1_0_13\jom.exe" (
		set "TEST_FEATURE=%TOOL_ROOT%\jom\1_0_13"
	)
